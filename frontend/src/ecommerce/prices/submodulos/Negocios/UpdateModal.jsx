...
import { updateNegocio } from "../../../../api/apis.js";

const UpdateModal = ({ mostrar, actualizarMostrar, negocioSeleccionado }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (valoresFormulario) => {
            ...
            try {
                await updateNegocio(priceSel._id, negocioSeleccionado.IdNegocioOK, valoresFormulario);
                setMensajeExitoAlert("Negocio actualizado y guardado correctamente");
            } catch (e) {
                setMensajeExitoAlert(null);
    ...
    useEffect(() => {
        formik.setFieldValue("IdNegocioOK", negocioSeleccionado.IdNegocioOK);
        formik.setFieldValue("Nombre", negocioSeleccionado.Nombre);
        formik.setFieldValue("Ubicacion", negocioSeleccionado.Ubicacion);
    }, [negocioSeleccionado]);

    {/* ============ Comprobar que se haya seleccionado un price y un precio ============ */ }
    if (!priceSel._id || !negocioSeleccionado.IdNegocioOK) {
        return (
