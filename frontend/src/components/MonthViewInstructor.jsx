...
function MonthViewInstructor({ month }) {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        const response = await axios.get(`http://localhost:3001/adana-api/v1/classes/instructor/${instructorId}`);
                    ...
                    <div
                      ...
                      onClick={async (e) => {
                        ...
                        try {
                          ...
                          console.log("Estudiantes inscritos:", response.data);
                        } catch (error) {
