              ...
              <h1 className="text-center font-[700] font-[Outfit] text-4xl pt-40">
                    Iniciar Sesión
                          ...
                          <div className="w-full flex justify-center px-4 sm:px-6 md:px-8">
                              <div className="w-full max-w-[1000px] transform translate-y-5">
                            ...
                            <div className="w-full flex justify-center px-4 sm:px-6 md:px-8 mt-6">
                              <div className="w-full max-w-[1000px] transform translate-y-10">
                        ...
                        <div className='w-full flex justify-center transform translate-y-15'> <label className='ml-2 font-medium text-blue-700'> Olvidé mi contraseña </label> </div>
                      
                      <div className='mt-8 flex flex-col items-center gap-y-4  translate-y-20'>
                        <div> <button className='w-[200px] h-12 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-4 rounded-xl text-[#FFFDEF] text-lg font-bold cursor-pointer'> 
                          ...
                          <button className=' flex items-center justify-center gap-2 w-[200px] h-12 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-4 rounded-xl text-[#FFFDEF] text-lg font-bold cursor-pointer'> 
                      ...
                      <div className='mt-10 flex justify-center items-center gap-x-3 transform translate-y-25'>
