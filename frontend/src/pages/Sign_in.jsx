                    ...
                    Iniciar Sesión
                      ...
                      className='mt-8 flex flex-col items-center gap-y-4  translate-y-20'>
                        <div> <button className='w-[200px] h-12 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-4 rounded-xl text-[#FFFDEF] text-lg font-bold cursor-pointer'> 
                          ...
                          <button 
                          onClick={handleLogin}
                          className=' flex items-center justify-center gap-2 w-[200px] h-12 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-4 rounded-xl text-[#FFFDEF] text-lg font-bold cursor-pointer'> 
