        ...
        <div className='flex-1 flex flex-col items-center justify-start pt-28 h-full ml-[-7.5px]'>
          ...
          <div className='transform translate-y-10'>
            ...
            <div className='mt-8 flex flex-row justify-center items-center gap-x-4 translate-y-18'>
              <button onClick={handleNormalRegister}
                className='w-[150px] h-12 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-4 rounded-xl text-[#FFFDEF] text-lg font-bold bg-blue-600 cursor-pointer'>
                Acceder
              </button>
